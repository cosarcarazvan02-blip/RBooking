...
/// <summary>
/// Sends real emails via SMTP when Smtp:Host is configured; otherwise just logs what
/// would have been sent, so the notification flow is exercisable without real credentials.
/// </summary>
