    ...
    <main className="min-h-[calc(100vh-80px)] flex flex-col justify-center items-center px-4 sm:px-6 py-12 text-neutral-900 dark:text-neutral-100">
      <div className="max-w-md w-full mx-auto bg-white dark:bg-[#111] border border-neutral-200 dark:border-neutral-800 p-8 rounded-2xl shadow-xl">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-serif tracking-wide text-neutral-900 dark:text-white">Autentificare Cont</h1>
        ...
        <div className="text-center mt-6 pt-6 border-t border-neutral-200 dark:border-neutral-800/60 font-mono">
          <Link href="/register" className="text-xs text-neutral-600 dark:text-neutral-400 hover:text-neutral-950 dark:hover:text-white transition tracking-wider">
            Nu ai un cont? <span className="text-neutral-950 dark:text-white underline underline-offset-4">Înregistrează-te</span>
          </Link>
        </div>
      </div>
    </main>
