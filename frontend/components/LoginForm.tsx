  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Dacă utilizatorul folosește un cont de test / demo, permitem autentificarea locală
        const isDemo = email.includes("@booking.com") || email.includes("@hotel.com");
        if (isDemo) {
  ...
  return (
    <div className="w-full max-w-lg mx-auto">
      ...
      <div className="bg-white dark:bg-[#131519] border border-neutral-300 dark:border-neutral-800 p-8 sm:p-10 shadow-sm">
        ...
        {errorMessage && (
          <div className="mb-6 p-4 bg-red-50 text-red-900 dark:bg-red-950/40 dark:text-red-200 text-xs flex items-center gap-3 border border-red-300 dark:border-red-800 animate-fadeIn">
        ...
        {successMessage && (
          <div className="mb-6 p-4 bg-emerald-50 text-emerald-900 dark:bg-emerald-950/40 dark:text-emerald-200 text-xs flex items-center gap-3 border border-emerald-300 dark:border-emerald-800 animate-fadeIn">
